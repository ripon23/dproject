...
<div class="col-md-6">
   ...
   <fieldset>
            ...
            <div class="form-group <?php echo (form_error('region_name')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">              	 
                <input id="region_name" name="region_name" type="text" placeholder="<?=lang('region_name')?>" value="<?=set_value('region_name')?>" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('region_name_bn')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">              	 
                <input id="region_name_bn" name="region_name_bn" type="text" placeholder="<?=lang('region_name_bn')?>" value="<?=set_value('region_name_bn')?>" class="form-control">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <textarea class="form-control" id="region_address" name="region_address" placeholder="<?=lang('region_address')?>" rows="5"><?=set_value('region_address')?></textarea>
              </div>
            </div> 
