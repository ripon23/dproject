            ...
            <li class="active"><a href="./">Fixed top <span class="sr-only">(current)</span></a></li>-->
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<?php if ($this->authentication->is_signed_in()) : ?>
							...
							$all_user_role=$this->general_model->get_all_table_info_by_id('a3m_rel_account_role', 'account_id', $account->id);
							echo "(";
							$role_info= $this->general_model->get_all_table_info_by_id('a3m_acl_role', 'id', $all_user_role->role_id);
							echo $role_info->name;
							echo ")";
