...
<div class="col-md-6">
   ...
   <fieldset>
            ...
            <div class="form-group <?php echo (form_error('sector_name')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">              	 
                <input id="sector_name" name="sector_name" type="text" placeholder="<?=lang('sector_name')?>" value="<?=set_value('sector_name')?>" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('sector_name_bn')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">              	 
                <input id="sector_name_bn" name="sector_name_bn" type="text" placeholder="<?=lang('sector_name_bn')?>" value="<?=set_value('sector_name_bn')?>" class="form-control">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7">
                <textarea class="form-control" id="sector_address" name="sector_address" placeholder="<?=lang('sector_address')?>" rows="5"><?=set_value('sector_address')?></textarea>
              </div>
            </div> 
