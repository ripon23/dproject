    ...
    <div class="col-md-8">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          <input type="text" class="form-control" name="relationship_with_gatekeeper" id="relationship_with_gatekeeper" placeholder="<?php echo lang('relationship_with_gatekeeper')?>">
          <span class="input-group-addon"></span></div>
