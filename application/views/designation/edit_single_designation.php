...
<ol class="breadcrumb">
  ...
  <li class="active"><?=lang('action_edit')?> <?=lang('menu_designation')?></li>
</ol>

<div class="well well-lg" style="overflow:hidden">
<legend class="text-center"><?=lang('action_edit')?> <?=lang('menu_designation')?> </legend>
...
<div class="col-md-6">
   ...
   <fieldset>
            ...
            <div class="form-group <?php echo (form_error('designation_name')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">              	 
                <input id="designation_name" name="designation_name" type="text" placeholder="<?=lang('designation_name')?>" value="<?=$designation_info->designation_name?>" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('designation_name_bn')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">              	 
                <input id="designation_name_bn" name="designation_name_bn" type="text" placeholder="<?=lang('designation_name_bn')?>" value="<?=$designation_info->designation_name_bn?>" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('designation_status')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-7">
                <label class="radio-inline">
                    <input type="radio" name="designation_status" id="designation_status" value="1" <?php if($designation_info->designation_status==1) echo 'checked';?>> <?=lang('active')?>
                </label>
                <label class="radio-inline">
                    <input type="radio" name="designation_status" id="designation_status" value="zero" <?php if($designation_info->designation_status==0) echo 'checked';?>> <?=lang('inactive')?>
                </label>
    ...
    <div class="panel panel-warning">
      ...
      <div class="panel-body">
        <ul class="list-unstyled">
            ...
            <li><a href="./designation/designation/create_designation"><?=lang('action_create')?> <?=lang('menu_designation')?> </a></li>
