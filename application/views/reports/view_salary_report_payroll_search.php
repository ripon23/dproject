...
<legend class="text-center"><?=lang('action_view')." ".lang('menu_salary_report')?> </legend>  
    <form class="form-horizontal" role="form" id="create-site-form"  name="create-site-form" action="./reports/report/salary_report_payroll_search" method="post">   
    <div class="col-md-12">
    ...
    <div id="export-menu" style="width:100%; margin-bottom:10px; text-align:right;"> 
        ...
        <a href="reports/report/download_excel_payroll/<?=$season_id?>/<?=$company_id?>/<?=$battalion_id?>" id="export-to-excel" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> <?=lang('download_in_excel')?></a>      
