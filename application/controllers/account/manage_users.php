	...
	function search_user()
  	{
		...
		if($this->input->post("search_submit"))
		{
			$searchSql =  "SELECT  a3m_account.id, a3m_account.username, a3m_account.email,  a3m_account_details.fullname, a3m_acl_role.name FROM `a3m_account` INNER JOIN a3m_account_details ON a3m_account.id = a3m_account_details.account_id 
INNER JOIN a3m_rel_account_role ON a3m_rel_account_role.account_id = a3m_account.id 
INNER JOIN a3m_acl_role ON a3m_acl_role.id = a3m_rel_account_role.role_id";
